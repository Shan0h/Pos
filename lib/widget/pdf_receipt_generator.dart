...
Future<PdfExportResult> pdfReceiptGenerator({
  ...
  final subtotal = sale.totalHarga + sale.diskon;
              ...
              children: <TableRow>[
                ...
                for (ProductItemModel item in sale.items)
                  TableRow(children: <Widget>[
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (item.diskonPersen != null && item.diskonPersen! > 0)
                            Text('${item.diskonPersen!.toStringAsFixed(0)}% off', style: const TextStyle(color: PdfColors.red, fontSize: 9)),
                        ],
                      ),
                    ),
                    ...
                    Container(padding: const EdgeInsets.all(8), alignment: Alignment.centerRight, child: Text(currency.format(item.price))),
                    Container(
                      padding: const EdgeInsets.all(8),
                      ...
                      child: Text(
                        currency.format(
                          (item.diskonPersen == null || item.diskonPersen == 0)
                              ...
                              : (item.price - (item.price * (item.diskonPersen! / 100))) * (item.quantity ?? 1),
                        ),
                      ),
                    ),
                  ]),
